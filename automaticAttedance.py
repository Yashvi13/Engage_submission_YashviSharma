...
# for choose station and fill attendance
def subjectChoose(text_to_speech):
    def FillAttendance():
        ...
        if sub == "":
            ...
            try:
                ...
                while True:
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        if conf < 70:
                            ...
                            aa = df.loc[df["mobile"] == Id]["Name"].values
                            global tt
                            tt = str(Id) + "-" + aa
                ...
                attendance = attendance.drop_duplicates(["mobile"], keep="first")
                print(attendance)
    ...
    subject.title("Station...")
    subject.geometry("580x320")
    subject.resizable(0, 0)
    subject.configure(background="#e4f1f2")
    # subject_logo = Image.open("UI_Image/0004.png")
    # subject_logo = subject_logo.resize((50, 47), Image.ANTIALIAS)
    # subject_logo1 = ImageTk.PhotoImage(subject_logo)
    titl = tk.Label(subject, bg="#e4f1f2", relief=RIDGE, bd=10, font=("arial", 30))
    titl.pack(fill=X)
    # l1 = tk.Label(subject, image=subject_logo1, bg="black",)
    # l1.place(x=100, y=10)
    titl = tk.Label(
        subject,
        text="Enter the station Name",
        fg="#34495e",
        bg="#e4f1f2",
        font=("arial", 25),
    )
    ...
    def Attf():
        ...
        if sub == "":
            ...
            os.startfile(
                "c:\\Users\\9yash\\Desktop\\github_reloaded\\Attendance\\gas.csv"
            )
